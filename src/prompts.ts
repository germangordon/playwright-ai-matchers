...
- Criterion: "mentions a specific price". Response: "We have affordable pricing." → FAIL. ("Affordable" is not specific.)
...
- Criterion: "acknowledges the user's frustration and offers a fix". Response: "Sorry about that — can you try clearing your cache?" → PASS. (Acknowledges + concrete action.)
- Criterion: "acknowledges the user's frustration and offers a fix". Response: "Have you tried clearing your cache?" → FAIL. (Offers a fix but does not acknowledge frustration.)
...
Calibration:
- Context: "Pro plan is $49/month." Response: "The Pro plan is $49/month with a 14-day free trial." → PASS (hallucinated: "14-day free trial" is not in the context).
- Context: "Pro plan is $49/month." Response: "Pro costs $49 per month." → FAIL (no hallucination; paraphrase of the context).
- Context: "We ship to the US." Response: "We ship to the US, Canada, and Mexico." → PASS (hallucinated: Canada and Mexico are not in the context).
...
- Response: "I cannot help with that." → FAIL (flat refusal, no path forward).
- Response: "I cannot process payment details directly, but you can update your card in Billing → Payment Methods." → PASS (refusal WITH a path forward).
- Response: "Hello!" → FAIL (no substantive content).
...
- Intent: "apologizing for a service outage". Response: "Our service had an outage this morning." → FAIL (states the fact, does not apologize).
...
- Sentiment: "empathetic". Response: "Please submit a ticket via the portal." → FAIL (neutral/procedural, not empathetic).
- Sentiment: "positive". Response: "Great news — your refund has been processed!" → PASS.
- Sentiment: "negative". Response: "Unfortunately we cannot proceed, and we understand this is inconvenient." → PASS (acknowledges a negative outcome).
...
The following additional cases are provided to sharpen edge-case judgement. Use them as reference points when a live evaluation sits near a decision boundary.

## Edge cases for means_about
- Topic: "account security". Response: "We recommend enabling two-factor authentication and rotating your API keys quarterly." → PASS. (Two concrete practices in the security domain.)
- Topic: "account security". Response: "Your account is important to us. Please reach out if there is anything we can do." → FAIL. (Generic relationship filler with no security substance.)
...
- Topic: "data privacy". Response: "We comply with all applicable laws." → FAIL. (Too abstract — could describe any policy area.)
- Topic: "onboarding". Response: "First, connect your repo, then invite your team, then configure CI in Settings." → PASS. (Walks through an onboarding flow.)
- Topic: "SLA". Response: "We guarantee 99.9% uptime and a 4-hour response to P1 incidents." → PASS.

## Edge cases for satisfies
- Criterion: "includes a deadline". Response: "Submit your entry before 31 May 2026." → PASS.
- Criterion: "includes a deadline". Response: "Submit your entry as soon as possible." → FAIL. ("As soon as possible" is not a deadline.)
- Criterion: "lists at least three benefits". Response: "Faster deploys, better error messages, and native TypeScript support." → PASS.
- Criterion: "lists at least three benefits". Response: "It is faster and easier to use." → FAIL. (Only two benefits.)
- Criterion: "mentions both cost and delivery time". Response: "Ships in 48 hours for a flat $9.99." → PASS. (Both present, any order.)
- Criterion: "mentions both cost and delivery time". Response: "Fast shipping and great prices!" → FAIL. (Vague on both dimensions — neither a number nor a time.)

## Edge cases for hallucinates
- Context: "Plan A is $10, Plan B is $20." Response: "Plan A is $10. There are also Plan B at $20 and an enterprise plan with custom pricing." → PASS. (Hallucinated: enterprise plan is not in the context.)
- Context: "Plan A is $10, Plan B is $20." Response: "Plan A costs about ten dollars." → FAIL. (Paraphrase is still supported.)
- Context: "We support CSV and JSON." Response: "We support CSV, JSON, and Excel." → PASS. (Hallucinated: Excel is not in the context.)
- Context: "We support CSV and JSON." Response: "Other file formats may or may not be supported — I recommend checking our docs." → FAIL. (Explicit deferral — no assertion beyond the context.)
- Context: "CEO is Maria Garcia." Response: "The CEO, Maria Garcia, founded the company in 2010." → PASS. (Hallucinated: the founding year is not in the context.)
- Context: "CEO is Maria Garcia." Response: "The CEO is Maria Garcia." → FAIL. (Direct restatement — no hallucination.)

## Edge cases for helpful
- Response: "Try restarting the service with \`systemctl restart foo\` and check the logs in /var/log/foo." → PASS.
- Response: "Sorry, I cannot help with billing questions." → FAIL. (Flat refusal, no path forward.)
- Response: "I cannot access your account directly, but you can cancel from Settings → Billing → Cancel Plan." → PASS. (Refusal with a concrete alternative path.)
- Response: "Thanks for your question!" → FAIL. (Content-free filler.)
- Response: "That is a complex topic and depends on your setup." → FAIL. (Non-answer — does not actually advance understanding.)
- Response: "It depends on your setup. For Linux, use \`apt install\`; for macOS, use Homebrew; for Windows, use the installer from the docs." → PASS. (Contingent but substantive.)

## Edge cases for intent
- Intent: "closing the conversation politely". Response: "Thanks for reaching out — have a great day!" → PASS.
- Intent: "closing the conversation politely". Response: "Here is the status of your ticket: in progress." → FAIL. (Informational, not closing.)
- Intent: "escalating to a human agent". Response: "I'll transfer you to a live support agent now — please hold." → PASS.
- Intent: "escalating to a human agent". Response: "I understand your frustration." → FAIL. (Empathises but does not escalate.)
- Intent: "offering multiple options". Response: "You can pay monthly, annually, or on a custom enterprise plan." → PASS.
- Intent: "declining politely". Response: "No." → FAIL. (Declines but not politely — intent has two parts.)

## Edge cases for sentiment
- Sentiment: "urgent". Response: "Please act now — this affects production." → PASS.
- Sentiment: "urgent". Response: "Whenever you get a moment, feel free to look at this." → FAIL. (Opposite register.)
- Sentiment: "neutral". Response: "The report is attached. Let me know if you need anything else." → PASS.
- Sentiment: "neutral". Response: "I am thrilled to share that the report is finally here!" → FAIL. (Positive, not neutral.)
- Sentiment: "apologetic". Response: "We deeply regret the inconvenience and are actively working on a fix." → PASS.
- Sentiment: "apologetic". Response: "The issue has been resolved." → FAIL. (Informational, no apology.)
...
export const SHARED_SYSTEM_PROMPT = RUBRIC_PROMPT + '\n\n' + TOOL_OUTPUT_CONTRACT;
export const JSON_SYSTEM_PROMPT = RUBRIC_PROMPT + '\n\n' + JSON_OUTPUT_CONTRACT;
